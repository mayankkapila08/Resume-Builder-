...
export default function Download({ form, template }) {
  ...
  const handleDownload = async () => {
    ...
    // ✅ Dynamic import (fixes Vercel build issue)
  ...
  return (
    ...
    >
      <h2 style={{ color: "#1a73e8", marginBottom: "1rem", fontSize: "2rem", fontWeight: 700 }}>
        Download Resume
      </h2>
      <p style={{ fontSize: "1.1rem", color: "#444", marginBottom: "2rem", textAlign: "center", maxWidth: "600px" }}>
